...
def and_i_have_a_group1_questionnaire_for_my_region(step, type):
    world.questionnaire, world.question = create_regional_questionnaire_with_one_question(world.region)

    if type == 'draft':
        TextAnswer.objects.create(question=world.question, country=world.uganda,
