...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'questionnaire_theme', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Theme.name'
        db.alter_column(u'questionnaire_theme', 'name', self.gf('django.db.models.fields.TextField')(max_length=100))
