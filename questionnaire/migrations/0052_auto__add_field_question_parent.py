...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'questionnaire_question', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='child', null=True, to=orm['questionnaire.Question']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.parent'
        db.delete_column(u'questionnaire_question', 'parent_id')
