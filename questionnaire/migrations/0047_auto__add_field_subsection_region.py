...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubSection.region'
        db.add_column(u'questionnaire_subsection', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sub_sections', null=True, to=orm['questionnaire.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubSection.region'
        db.delete_column(u'questionnaire_subsection', 'region_id')
