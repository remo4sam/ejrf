...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'QuestionGroupOrder', fields ['question', 'order', 'question_group']
        db.create_unique(u'questionnaire_questiongrouporder', ['question_id', 'order', 'question_group_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestionGroupOrder', fields ['question', 'order', 'question_group']
        db.delete_unique(u'questionnaire_questiongrouporder', ['question_id', 'order', 'question_group_id'])
