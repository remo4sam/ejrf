...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'questionnaire_question', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions', null=True, to=orm['questionnaire.Theme']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.theme'
        db.delete_column(u'questionnaire_question', 'theme_id')
