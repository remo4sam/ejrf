...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionGroup.hybrid'
        db.add_column(u'questionnaire_questiongroup', 'hybrid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionGroup.hybrid'
        db.delete_column(u'questionnaire_questiongroup', 'hybrid')
