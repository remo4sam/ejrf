...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.questionnaire'
        db.add_column(u'questionnaire_answer', 'questionnaire',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='answers', null=True, to=orm['questionnaire.Questionnaire']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.questionnaire'
        db.delete_column(u'questionnaire_answer', 'questionnaire_id')
