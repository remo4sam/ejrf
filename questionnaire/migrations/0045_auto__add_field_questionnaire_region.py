...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.region'
        db.add_column(u'questionnaire_questionnaire', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='questionnaire', null=True, to=orm['questionnaire.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.region'
        db.delete_column(u'questionnaire_questionnaire', 'region_id')
