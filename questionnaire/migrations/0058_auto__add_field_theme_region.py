...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.region'
        db.add_column(u'questionnaire_theme', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='themes', null=True, to=orm['questionnaire.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.region'
        db.delete_column(u'questionnaire_theme', 'region_id')
