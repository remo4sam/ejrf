...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.region'
        db.add_column(u'questionnaire_section', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sections', null=True, to=orm['questionnaire.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.region'
        db.delete_column(u'questionnaire_section', 'region_id')
