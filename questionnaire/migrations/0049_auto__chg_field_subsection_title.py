...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubSection.title'
        db.alter_column(u'questionnaire_subsection', 'title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'SubSection.title'
        db.alter_column(u'questionnaire_subsection', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
