...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.region'
        db.add_column(u'questionnaire_question', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions', null=True, to=orm['questionnaire.Region']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Question.region'
        db.delete_column(u'questionnaire_question', 'region_id')
